...
public class NowPlayingMovieDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_now_playing_movie_details);
        ...
        backdrop=intent.getStringExtra("posterpath");
        release=intent.getStringExtra("release");
        final int id=intent.getIntExtra("id",-1);
        id123=id;
        voteAvg=intent.getStringExtra("voteavg");
        if(intent.getStringExtra("voteavg")!=null)
        {
        ...
        if(intent.getStringExtra("overview")!=null)
        {
        ...
        relatedAdapter=new RelatedAdapter(relatedArrayList, this, new RelatedAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent2=new Intent(NowPlayingMovieDetails.this,NowPlayingMovieDetails.class);
    ...
    private void fetchProduction(int id) {
        ...
        Call<ProductionHeirarchy> call=customApi.getProduction(id);
    ...
    private void fetchRelated(int id) {
        Retrofit retrofit=new Retrofit.Builder()
                ...
                .build();
        CustomApi customApi=retrofit.create(CustomApi.class);
        Call<Related> call=customApi.getRelated(id);
    ...
    private void fetchCast(int id) {
        Retrofit retrofit=new Retrofit.Builder()
                ...
                .build();
        CustomApi customApi=retrofit.create(CustomApi.class);
        Call<CastHeirarchy> call=customApi.getCast(id);
